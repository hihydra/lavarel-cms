...
<div class="row wrapper border-bottom white-bg page-heading">
  <div class="col-lg-10">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">
            <strong>{!!trans('admin/breadcrumb.article.edit')!!}</strong>
        </li>
    </ol>
  </div>
</div>
    ...
    <div class="col-lg-12">
      <div class="ibox float-e-margins">
        <div class="ibox-title">
          <h5>{!!trans('admin/article.edit')!!}</h5>
        ...
        <div class="ibox-content">
          <form method="post" action="{{url('admin/article/'.$article->id)}}" class="form-horizontal">
            {{csrf_field()}}
            {{method_field('PUT')}}
            ...
            <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" name="title" value="{{$article->title}}" placeholder="{{trans('admin/article.model.title')}}">
                @if ($errors->has('title'))
            ...
            <div class="form-group{{ $errors->has('intro') ? ' has-error' : '' }}">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" name="intro" value="{{$article->intro}}" placeholder="{{trans('admin/article.model.intro')}}">
                @if ($errors->has('intro'))
