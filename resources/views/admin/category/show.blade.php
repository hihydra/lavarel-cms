...
<div class="ibox float-e-margins animated bounceIn formBox" id="showBox">
  ...
  <div class="ibox-content">
    <form class="form-horizontal" id="showForm">
      ...
      <div class="hr-line-dashed"></div>
      <div class="form-group">
        <label class="col-sm-3 control-label">{{trans('admin/category.model.slug')}}</label>
        <div class="col-sm-9">
      ...
      <div class="hr-line-dashed"></div>
      <div class="form-group">
        <label class="col-sm-3 control-label">{{trans('admin/category.model.url')}}</label>
        <div class="col-sm-9">
      ...
      <div class="hr-line-dashed"></div>
      <div class="form-group">
        <label class="col-sm-3 control-label">{{trans('admin/category.model.active')}}</label>
        <div class="col-sm-9">
      ...
      <div class="hr-line-dashed"></div>
      <div class="form-group">
        <label class="col-sm-3 control-label">{{trans('admin/category.model.description')}}</label>
        <div class="col-sm-9">
